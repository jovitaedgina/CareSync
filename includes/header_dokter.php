...
<body class="bg-gray-50 text-gray-800 font-sans antialiased flex h-screen overflow-hidden">
    ...
    <aside class="w-64 bg-white shadow-lg border-r border-gray-200 flex flex-col hidden md:flex z-20">
        ...
        <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
            <a href="dashboard.php" class="flex items-center px-4 py-3 rounded-xl transition <?php echo ($current_page == 'dashboard.php') ? 'bg-blue-600 text-white shadow-md' : 'text-gray-600 hover:bg-blue-50 hover:text-blue-600'; ?>">
                <i class="fa-solid fa-chart-pie w-6"></i>
                <span class="font-medium ml-3">Dashboard</span>
            </a>
            
            <a href="jadwal.php" class="flex items-center px-4 py-3 rounded-xl transition <?php echo ($current_page == 'jadwal.php') ? 'bg-blue-600 text-white shadow-md' : 'text-gray-600 hover:bg-blue-50 hover:text-blue-600'; ?>">
                <i class="fa-solid fa-calendar-week w-6"></i>
                <span class="font-medium ml-3">Jadwal Praktik</span>
            </a>

            <a href="consultation_room.php" class="flex items-center px-4 py-3 rounded-xl transition <?php echo ($current_page == 'consultation_room.php') ? 'bg-blue-600 text-white shadow-md' : 'text-gray-600 hover:bg-blue-50 hover:text-blue-600'; ?>">
                <i class="fa-solid fa-comment-medical w-6"></i>
                <span class="font-medium ml-3">Ruang Konsultasi</span>
            </a>

            <a href="patient_history.php" class="flex items-center px-4 py-3 rounded-xl transition <?php echo ($current_page == 'patient_history.php') ? 'bg-blue-600 text-white shadow-md' : 'text-gray-600 hover:bg-blue-50 hover:text-blue-600'; ?>">
        ...
        <header class="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-6 z-10 shrink-0">
            ...
            <div class="flex items-center space-x-4 ml-auto">
                <button class="text-gray-400 hover:text-blue-600 transition relative">
                    ...
                    <span class="absolute top-0 right-0 -mt-1 -mr-1 flex h-3 w-3 items-center justify-center rounded-full bg-red-500 text-[8px] text-white">2</span>
                </button>
                ...
                <div class="relative ml-2 pl-4 border-l border-gray-200" x-data="{ profileOpen: false }">
                    <button @click="profileOpen = !profileOpen" @click.away="profileOpen = false" class="flex items-center gap-3 focus:outline-none hover:bg-gray-50 py-1 px-2 rounded-lg transition">
                        <img src="https://ui-avatars.com/api/?name=Dokter+Susanti&background=0D8ABC&color=fff" alt="Dokter" class="w-8 h-8 rounded-full object-cover border border-gray-200">
                        <div class="hidden sm:flex flex-col text-left">
                            <span class="text-sm font-bold text-gray-800 leading-none">dr. Susanti W.</span>
                            <span class="text-[10px] text-gray-500 mt-1 leading-none">Sp.KK</span>
                        </div>
                    ...
                    <div x-show="profileOpen" 
                        ...
                        <div class="px-4 py-2 mb-2 border-b border-gray-50">
                            ...
                            <p class="text-sm font-bold text-gray-900 truncate">susanti.w@caresync.com</p>
                        </div>
                        ...
                        <a href="#" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition">
                            <i class="fa-solid fa-shield-halved w-5"></i> Ganti Password
                        </a>
