...
<body class="bg-slate-50 text-slate-800 font-sans antialiased flex h-screen overflow-hidden">
    ...
    <aside class="w-64 bg-[#0f172a] shadow-xl flex flex-col hidden md:flex z-20 text-slate-300">
        ...
        <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
            ...
            <a href="dashboard.php" class="flex items-center px-4 py-3 rounded-xl transition <?php echo ($current_page == 'dashboard.php') ? 'bg-indigo-600 text-white shadow-md' : 'hover:bg-slate-800 hover:text-white'; ?>">
            ...
            <a href="manage_staff.php" class="flex items-center px-4 py-3 rounded-xl transition <?php echo ($current_page == 'manage_staff.php') ? 'bg-indigo-600 text-white shadow-md' : 'hover:bg-slate-800 hover:text-white'; ?>">
                <i class="fa-solid fa-user-doctor w-6"></i>
                <span class="font-medium ml-3">Manajemen Staf</span>
            </a>

            <a href="patient_data.php" class="flex items-center px-4 py-3 rounded-xl transition <?php echo ($current_page == 'patient_data.php') ? 'bg-indigo-600 text-white shadow-md' : 'hover:bg-slate-800 hover:text-white'; ?>">
            ...
            <a href="reports.php" class="flex items-center px-4 py-3 rounded-xl transition <?php echo ($current_page == 'reports.php') ? 'bg-indigo-600 text-white shadow-md' : 'hover:bg-slate-800 hover:text-white'; ?>">
        ...
        <div class="p-4 border-t border-slate-800 shrink-0 bg-[#0b1120]">
            <a href="../../logout.php" class="flex items-center px-4 py-3 text-red-400 hover:bg-red-500/10 hover:text-red-300 rounded-xl transition font-bold group">
            ...
            <div class="flex items-center space-x-4 ml-auto">
                ...
                <div class="relative ml-2 pl-4 border-l border-slate-200" x-data="{ profileOpen: false }">
                    <button @click="profileOpen = !profileOpen" @click.away="profileOpen = false" class="flex items-center gap-3 focus:outline-none hover:bg-slate-50 py-1 px-2 rounded-lg transition">
                        <div class="w-8 h-8 rounded-full bg-indigo-100 text-indigo-600 flex items-center justify-center font-bold border border-indigo-200">AD</div>
                        <div class="hidden sm:flex flex-col text-left">
                            <span class="text-sm font-bold text-slate-800 leading-none">Super Admin</span>
                            <span class="text-[10px] text-slate-500 mt-1 leading-none">Management</span>
                        </div>
